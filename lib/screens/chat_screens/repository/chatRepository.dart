...
import '../../../provider/messageReplyProvider.dart';
...
// users -> reciever user id => chats -> current user id -> set data
      ...
      var senderChatContact = ChatContact(
        name: recieverUserData!.fullName!,
  ...
  void sendTextMessage({
    ...
    try {
      ...
      _saveMessageToMessageSubcollection(
        ...
        recieverUserName: recieverUserData?.fullName,
  ...
  void sendFileMessage({
    ...
    try {
      ...
      _saveMessageToMessageSubcollection(
        ...
        timeSent: timeSent,
        messageId: messageId,
        username: senderUserData.userId!,
        messageType: messageEnum,
        messageReply: messageReply,
        recieverUserName: recieverUserData?.userId,
        senderUsername: senderUserData.userId!,
        isGroupChat: isGroupChat,
      );
    } catch (e) {
      showSnackBar(context, e.toString());
  ...
  void sendGIFMessage({
    ...
    try {
      ...
      _saveMessageToMessageSubcollection(
        ...
        messageId: messageId,
        username: senderUser.userId!,
        messageReply: messageReply,
        recieverUserName: recieverUserData?.userId,
        senderUsername: senderUser.userId!,
        isGroupChat: isGroupChat,
      );
    } catch (e) {
      showSnackBar(context, e.toString());
