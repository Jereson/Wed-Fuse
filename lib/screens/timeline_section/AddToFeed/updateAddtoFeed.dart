...
class UpdateAddFeed extends StatefulWidget {
  const UpdateAddFeed({Key? key, required this.pic, required this.postId,
    required this.postImage,
    required this.images,
    required this.textOn, required this.friends}) : super(key: key);
            ...
            body: pVm.cachedUserDetail == null
              ...
              child: Column(
                ...
                children: [
                  ...
                  widget.images.isEmpty?Container():  SizedBox(
                    height: 100,
                  ...
                  widget.images.isEmpty?Container(): const Icon(Icons.swap_vert),
                  SizedBox(
                    height: 100,
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                  ...
                  InkWell(
                      onTap: () async{
                        ...
                        if(_selectedValue==1){
                          ...
                          print("1");
                          AddToFeed().addUpdate(selectedImages: selectedImages, messageTitleController: _messageTitleController, pVm: pVm, context: context, uploadTask: uploadTask, updateId: widget.postId, documentList: documentList);


                        }else if (_selectedValue==2){
                          print("2");
                          AddToFeed().addUpdate(selectedImages: selectedImages, messageTitleController: _messageTitleController, pVm: pVm, context: context, uploadTask: uploadTask, updateId: widget.postId, documentList: widget.friends);
                      ...
                      //  AddToFeed().addUpdate(selectedImages: selectedImages, messageTitleController: _messageTitleController, pVm: pVm, context: context, uploadTask: uploadTask, updateId: widget.postId);
                      },
                      child: Padding(
                        padding: const EdgeInsets.only(
                            left: 16.0, right: 16),
